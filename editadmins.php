...
<form action="editadminprocess.php" method="post">
         ...
         <label>Full Name<br><input class="input" type="text" name="name" value="<?php echo htmlspecialchars($row['name'] ?? ''); ?>" required></label>         
			...
			<div class="form-elemnt my-4">
			<label>Role<br><input class="input" type="text" name="role" value="<?php echo htmlspecialchars($row['role'] ?? ''); ?>" required></label>
            </div>
			<div class="form-elemnt my-4">
            ...
            <div class="form-element my-4"><br>
               <center> <input type="submit" name="editadmin" value="Edit Record" class="btn btn-primary"></center>
            </div>
                <?php
            }else{
